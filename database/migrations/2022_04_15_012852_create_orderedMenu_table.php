...
class CreateOrderedMenuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('orderedMenu', function (Blueprint $table) {
            ...
            $table->foreign('PK_FK_menuID', 'PK_FK_menuIDOrderedMenu')->references('pk_menuid')->on('menu')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('orderedMenu');
    }
}
