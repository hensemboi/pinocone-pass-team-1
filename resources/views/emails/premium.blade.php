        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-12 text-center text-lg-left">
                    <h1 class="mb-4" style="text-align: center">You have Activated The Premium Plan.</h1>
                    <div class="card match-height" style="text-align: center">
                        <div class="card-body text-center">
                            <div class="div text-center" style="margin-bottom: 20px;"><i
                                    class="card-icon ti-panel mb-4"></i>
                            </div>
                            <h3 class="card-title h4">Premium Package</h3>
                            <p class="card-text">20 Vouchers.</p>
    ...
    <footer>
        <div class="container" style="text-align: center">
            <div class="py-4 text-center" style="text-align: center">
                <small class="text-light">Copyright © 2022 by <a href="https://Cybinix.com/">Cybinix</a></small>
            </div>
        </div>
    </footer>
=======
