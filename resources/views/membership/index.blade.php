                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="div text-center">
                                ...
                                @if (Auth::guard('web')->user()->package == '0')
                                    <a href="/pinocone/subscribe/basic" class="text-center btn btn-sm btn-primary "
                    ...
                    <div class="card match-height">
                        <div class="card-body text-center">
                            ...
                            <div class="div text-center">
                                @if (Auth::guard('web')->check() == true)
                                @if (Auth::guard('web')->user()->package == '0')
                                    <a href="/pinocone/subscribe/standard" class="text-center btn btn-sm btn-primary "
                                        style="margin-top: 12px;">Subscribe</a>
                                @endif
                                @else
                                <a href="/pinocone/subscribe/standard" class="text-center btn btn-sm btn-primary "
                    ...
                    <div class="card match-height">
                        <div class="card-body text-center">
                            ...
                            <div class="div text-center">
                                @if (Auth::guard('web')->check() == true)
                                @if (Auth::guard('web')->user()->package == '0' ?? '')
                                    <a href="/pinocone/subscribe/premium" class="text-center btn btn-sm btn-primary "
                                        style="margin-top: 12px;">Subscribe</a>
                                @endif
                                @else
                                <a href="/pinocone/subscribe/premium" class="text-center btn btn-sm btn-primary "
