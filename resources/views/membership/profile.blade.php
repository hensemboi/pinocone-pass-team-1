...
>>>>>>> Stashed changes
                <div class="col-lg-7 text-center text-lg-left">
                    ...
                    <form class="search-wrapper" method="POST" action="/post/pinocone/profile">
                        @csrf
                        <div class="row">
                            <div class="col-12">
